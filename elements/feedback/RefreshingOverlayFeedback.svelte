...
>
  <span
    class="flex justify-center items-center shadow-md h-full min-h-full min-w-[9rem] w-36 gap-2 pl-6 pr-8 bg-aps1 text-b3 rounded-full {!$userPreferences
      .colorScheme.isActiveFgFg
      ? ' text-bgs1'
      : ''}"
  >
