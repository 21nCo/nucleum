...
{#if isCircled}
  {#if variant === IconVariant.Outline}
    {#if direction === Placement.Left}
      ...
      />
    {:else if direction === Placement.Right}
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        d="M12.75 15l3-3m0 0l-3-3m3 3h-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
      />
    {:else if direction === Placement.Top}
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        d="M15 11.25l-3-3m0 0l-3 3m3-3v7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
      />
    {:else if direction === Placement.Bottom}
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
...
{:else if !isCircled}
  {#if variant === IconVariant.Outline}
    ...
    {:else if direction === Placement.Bottom}
      ...
      />
    {:else if direction === Placement.BottomRight}
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        d="M4.5 4.5l15 15m0 0V8.25m0 11.25H8.25"
      />
    {:else if direction === Placement.BottomLeft}
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
        d="m19.5 4.5-15 15m0 0h11.25m-11.25 0V8.25"
      />
    {:else if direction === Placement.TopRight}
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
