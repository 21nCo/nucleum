<script lang="ts">
  ...
  import NestedGoalAccordion from "$lib/client/components/pointron/goals/NestedGoalAccordion.svelte";
  import Autocomplete from "$lib/client/elements/autocomplete/Autocomplete.svelte";
  import TagsContainer from "$lib/client/components/pointron/goals/TagsContainer.svelte";
