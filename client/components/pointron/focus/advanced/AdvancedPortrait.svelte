<script lang="ts">
  ...
  import StartEndBar from "$lib/client/components/pointron/focus/elements/intervalbar/IntervalBar.svelte";
  ...
  import IntervalBar from "$lib/client/components/pointron/focus/elements/intervalbar/IntervalBar.svelte";
