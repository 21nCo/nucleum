...
{#if variant === "v1" && info}
  <div
    class="text-left text-b2 text-bgs1 bg-fgs2 shadow-md rounded-md p-4 min-w-[25rem] max-w-sm text-wrap"
  >
...
{:else}
  <div
    class="min-w-fit whitespace-nowrap bg-fgs2 text-bgs1 text-b3 rounded-md z-30 px-4 py-1"
  >
    {tooltip ?? info?.body}
  </div>
{/if}
