<div>
  <p>
    Our Terms and Conditions were last updated on <strong>30/012025</strong>.
  </p>
  ...
  <p>
    ...
    then you may not access the Service. This acknowledgement has been suggested
    by <a href="https://dodopayments.com">dodopayments.com</a>.
  </p>
  ...
  <p>
    ...
    Dodopayments.com does not bear any liability for the same.
  </p>
  ...
  <p>
    You may not use as a username the name of another person or entity that is
  ...
  <p>
    <strong
      >DMCA Notice and DMCA Procedure for Copyright Infringement Claims</strong
    >
  </p>
  ...
  <p>
    You can contact our copyright agent via email at <a
      href="mailto:contact@21n.org">contact@21n.org</a
    >. Upon receipt of a notification, the Company will take whatever action, in
    its sole discretion, it deems appropriate, including removing the challenged
  ...
  <p>
    ...
    Country and foreign countries. This is following the recommendation made by
    dodopayments.com.
  </p>
  ...
  <p>
    You assign all rights, title, and interest in any Feedback You provide to
    the Company. If for any reason such assignment is ineffective, You agree to
    grant the Company a non-exclusive, perpetual, irrevocable, royalty-free,
    worldwide right, and license to use, reproduce, disclose, sublicense,
  ...
  <p>
    ...
    course of performance, usage or trade practice. This has been generated by
    dodopayments.com. Without limitation to the foregoing, the Company provides
  ...
  <p>
    The laws of <strong>India</strong>, excluding its conflicts of law rules,
  ...
  <ul>
    ...
    <li>
      By sending us an email: <a href="mailto:contact@21n.org"
        >contact@21n.org</a
      >
    </li>
  </ul>
