<div>
  <h1><strong>Return &amp; Refund Policy</strong></h1>

  <p>
    Our Return and Refund Policy was last updated on <strong>30/01/2025</strong
    >.
  </p>
  ...
  <ul>
    ...
    <li>
      If a technical issue caused by our platform prevents you from accessing
      the features you paid for, and the issue cannot be resolved within a
  ...
  <p>
    Refund requests must be made within <strong>30</strong> days of the payment date.
  ...
  <ol>
    <li>
      Contact our support team at <a href="mailto:contact@21n.org"
        >contact@21n.org</a
      >.
    </li>
    <li>
      Provide your payment receipt, order ID, and a detailed explanation of the
      issue.
    </li>
    <li>
    ...
    <li>
      If your request is approved, the refund will be processed to your original
      payment method within 7-10 business days.
    </li>
    <li>
      This has been generated by <a href="https://dodopayments.com"
        >dodopayments.com</a
      >
    </li>
  </ol>
  ...
  <p>
    If you have any questions about this Refund Policy or require assistance,
    please reach out to us:
  </p>

  <p>Email: <a href="mailto:contact@21n.org">contact@21n.org</a></p>
</div>
