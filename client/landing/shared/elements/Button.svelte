...
<button
  ...
  class={cn(
    "box-border flex items-center justify-center gap-3 rounded-lg font-medium",
    type == "primary" &&
    ...
    type == "primary" &&
      !isShort &&
      "text-[24px] py-5 px-[60px] mo:py-4 mo:px-[28px]",
    type == "secondary" && !isShort && "w-[360px] h-[72px]",
