  ...
  */
  ...
  async saveClip(data: IClipCapture) {
    ...
    if (clip.contentType === NodeType.WEB_SCREENSHOT_CLIP) {
      feedbackPane.focus(clipNode, { message: "Clip saved!", type: AlertType.SUCCESS });
    }
    return clip;
  ...
  async saveTweet(
    ...
    feedbackPane.focus(tweet, { message: "Tweet saved!", type: AlertType.SUCCESS });
    return tweetNode;
  }
  ...
  async saveTwitterProfile(
    ...
    feedbackPane.focus(node, { message: "Twitter profile saved!", type: AlertType.SUCCESS });
    return node;
  }
...
class FeedbackPaneStore extends ObservableStore<IFeedbackPaneStore> {
  ...
  focus(clip: IClip | null, message: string | { message: string; type: AlertType }) {
