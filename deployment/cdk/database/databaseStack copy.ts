...
export class DatabaseLightsailRegionalStack extends NestedStack {
  ...
  constructor(scope: Construct, id: string, props: CustomNestedStackProps) {
    ...
    new AwsCustomResource(this, "LightsailInstance", {
      onCreate: {
        service: "Lightsail",
        action: "createInstances",
        parameters: {
          instanceNames: [this.regionDomain],
          availabilityZone: this.env.region,
          blueprintId: "amazon_linux_2023",
          bundleId: "small_3_0",
          keyPairName: keypairName
        },
        physicalResourceId: PhysicalResourceId.of(this.regionDomain)
      },
      onDelete: {
        service: "Lightsail",
    ...
    // instance.node.addDependency(keyPairCheck);
    ...
    const staticIp = new CfnStaticIp(this, "LightsailStaticIp", {
      staticIpName: this.regionDomain + "-static-ip"
    });
    ...
    new ARecord(this, "DNSRecord", {
      ...
      target: RecordTarget.fromIpAddresses(staticIp.ref)
    });
